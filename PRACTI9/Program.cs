...
namespace Snake
{
    ...
    internal class Program
    {
        ...
        private static void Draw()
        {
            ...
            {
                new string('X', _size.Width - 2).Write(1, i, ConsoleColor.White, ConsoleColor.Black);
            }

            _head.Write("$", ConsoleColor.Red, ConsoleColor.Black);
            _tail.Write("O", ConsoleColor.Red, ConsoleColor.Black);
            _fruit.Write("6", ConsoleColor.DarkRed, ConsoleColor.Black);

            $"Яблоки: {_tail.Count()}".Write(_size.Width + 3, 5);
        }
        ...
        {
            $"Вы проиграли, попробуйте еще раз.".Write(_size.Width + 3, 3, ConsoleColor.Red, ConsoleColor.White);
            $"Нажмите space что бы попробовать еще раз".Write(_size.Width + 3, 4, ConsoleColor.Black, ConsoleColor.Gray);
